...
define(['sockjs', 'jquery', 'flot', 'flot_time', 'handlebars', 'cjs!netmask'],
	function(SockJS, jquery, flot, flot_time, Handlebars, netmask)
	{
		...
		Controller.prototype.run = function()
		{
			...
			jquery('button[name=netgraph-home-network-add-button]').click(
				function(e) {
					...
					var network_list = controller.options.home_networks;
		...
		Controller.prototype._remove_home_network = function(netmask_object,
			target_query)
		{
			var input = jquery('input', target_query);
			var new_home_networks = jquery.grep(
				this.options.home_networks,
				function(network, i)
				{
